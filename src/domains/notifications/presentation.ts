// Mirrors cente-leads-mobile's src/domains/notifications/presentation.ts —
// keep both in sync if templates change.
export const TEMPLATE_LABELS: Record<string, string> = {
  'lead.submitted_to_chair': 'Submitted for chair endorsement',
